...
#include "app.h"
//#include "/Users/austinlawrence/microchip/harmony/v1_03_01/apps/usb/device/hid_mouse/firmware_austin copy/src/accel.h" //library for using the accelerometer
...
void APP_Tasks ( void )
{
    ...
    char str[30];
//    sprintf(str, "Hi world 1337!");
//    write_string(str, 28, 32);
    
//    display_clear();
//    counter += 1;
//    sprintf(str,"aX = %1.3f",(float)x_scaled);
